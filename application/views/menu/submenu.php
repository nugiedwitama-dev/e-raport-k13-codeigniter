...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <a href="" class="btn btn-primary mb-3" style="background-color: navy;" data-toggle="modal" data-target="#newSubMenuModal">Tambah Sub Menu</a>
                ...
                <tbody>
                    ...
                    <?php foreach ($subMenu as $sm){ ?>
                        <tr>
                            ...
                            <td><?= $sm['icon']; ?></td>
                            <td><?= $sm['is_active']; ?></td>
                            <td width="20px"><?= anchor('menu/submenu_update/'.$sm['id'],'<div class="btn btn-sm btn-success">
                                <i class="fa fa-edit"></i></div>') ?></td>
                             <td width="20px"><?= anchor('menu/submenu_delete/'.$sm['id'],'<div class="btn btn-sm btn-danger">
