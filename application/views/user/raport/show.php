<main role="main" class="ml-sm-auto px-md-4">
  ...
  <div class="row mb-2">
    ...
    <a href="<?= base_url('user/raport')?>" type="button" class="btn btn-primary mb-2">
        <i class="fas fa-filter"></i> Ubah Data Raport
    </a>
    <a href="<?= base_url('user/cetak_cover')?>" type="button" class="btn btn-warning mb-2">
        <i class="fas fa-file-pdf"></i> Cetak Cover
    </a>
    <a href="<?= base_url('user/cetak_cover')?>" type="button" class="btn btn-warning mb-2">
        <i class="fas fa-file-pdf"></i> Cetak Biodata
    </a>
    <a href="<?= base_url('user/cetak_raport')?>" type="button" class="btn btn-warning mb-2">
        <i class="fas fa-file-pdf"></i> Cetak Raport
    </a>
    <a href="<?= base_url('user/cetak_kompetensi')?>" type="button" class="btn btn-warning mb-2">
        <i class="fas fa-file-pdf"></i> Cetak Kompetensi
    </a>
    <a href="<?= base_url('user/cetak_pengembangan_diri')?>" type="button" class="btn btn-warning mb-2">
        <i class="fas fa-file-pdf"></i> Cetak Pengembangan Diri
    </a>
    <a href="<?= base_url('user/cetak_full_raport')?>" type="button" class="btn btn-danger mb-2">
